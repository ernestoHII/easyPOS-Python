...
# Form implementation generated from reading ui file 'UnitDetail.ui'
#
...
"color: rgb(255, 255, 255);")
        ...
        self.txtUnit = QtWidgets.QTextEdit(self.frame_2)
        self.txtUnit.setGeometry(QtCore.QRect(140, 10, 300, 31))
        self.txtUnit.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.txtUnit.setObjectName("txtUnit")
        self.lblUnit = QtWidgets.QLabel(self.frame_2)
        self.lblUnit.setGeometry(QtCore.QRect(10, 10, 120, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
    ...
    def retranslateUi(self, Form):
        ...
        self.lblTaxDetail.setText(_translate("Form", "Unit Detail"))
        self.btnSave.setText(_translate("Form", "Enter - Save"))
        self.btnClose.setText(_translate("Form", "Esc - Close"))
        self.lblUnit.setText(_translate("Form", "Unit:"))

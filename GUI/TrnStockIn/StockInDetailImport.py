...
# Form implementation generated from reading ui file 'StockInDetailImport.ui'
#
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(10, 70, 100, 32))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(120, 70, 370, 30))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Stock-In Detail Import"))
        self.pushButton.setText(_translate("Dialog", "View"))
        self.pushButton_2.setText(_translate("Dialog", "Close"))
        self.pushButton_6.setText(_translate("Dialog", "Import"))
        self.pushButton_7.setText(_translate("Dialog", "Close"))
        self.pushButton_8.setText(_translate("Dialog", "Choose File"))
